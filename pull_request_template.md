...
- [ ] Source dependency commits are immutable.
- [ ] Product assertions execute through at least one real dependency lane.
- [ ] Failure and recovery paths execute.
- [ ] Logs contain no secrets, raw private media, or unredacted message content.
